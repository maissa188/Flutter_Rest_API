...
import 'package:app_crud/services/api_service.dart';
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            ElevatedButton(
                                 ...
                                 api.updateCases(id, Cases(name: _nameController.text, gender: gender, age: int.parse(_ageController.text), address: _addressController.text, city: _cityController.text, country: _countryController.text, status: status, updated: '', id: ''));
