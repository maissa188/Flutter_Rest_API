import 'package:app_crud/edidatawidget.dart';
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(widget.cases.gender, style: Theme.of(context).textTheme.titleMedium)
                          ],
                        ),
                      ),
                      Container(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(widget.cases.address, style: Theme.of(context).textTheme.titleSmall)
                          ],
                        ),
                      ),
                      Container(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(widget.cases.country, style: Theme.of(context).textTheme.titleMedium)
                          ],
                        ),
                      ),
                      Container(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(widget.cases.updated!, style: Theme.of(context).textTheme.titleMedium)
                          ],
                        ),
                      ),
                      Container(
